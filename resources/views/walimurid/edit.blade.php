            ...
            <div class="col-lg-10">
                <div class="card shadow-lg border-0">
                    <div class="card-header bg-brand text-white text-center py-4">
                        <h2 class="mb-0">Edit Data Murid</h2>
                    ...
                    <div class="card-body p-4">
                        ...
                        <form method="POST" action="{{ route('walimurid.update') }}" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')

                            <!-- SECTION 1: DATA ANAK -->
                            <div class="form-section">
                                <h5 class="section-header">1. Data Anak</h5>
                                <div class="form-section-body">
                                    <div class="row">
                                        <div class="col-md-6 mb-3">
                                            <label for="no_induk_sekolah" class="form-label">No. Induk Sekolah</label>
                                            <input type="text" class="form-control" id="no_induk_sekolah" name="no_induk_sekolah" value="{{ old('no_induk_sekolah', $murid->no_induk_sekolah ?? '') }}" maxlength="50">
                                        </div>
                                        <div class="col-md-6 mb-3">
                            ...
                            <div class="form-section">
                                <h5 class="section-header">2. Data Alamat</h5>
                                <div class="form-section-body">
                                    <div class="row">
                            ...
                            <div class="form-section">
                                <h5 class="section-header">3. Data Ayah</h5>
                                <div class="form-section-body">
                                    <div class="row">
                                        <div class="col-md-8 mb-3">
                            ...
                            <div class="form-section">
                                <h5 class="section-header">4. Data Ibu</h5>
                                <div class="form-section-body">
                                    <div class="row">
                                        <div class="col-md-8 mb-3">
                            ...
                            <div class="form-section">
                                <h5 class="section-header">5. Upload Ulang Bukti Pembayaran</h5>
                                <div class="form-section-body">
                                    <div class="alert alert-warning">
                                        <strong>Penting:</strong> Pembayaran Anda ditolak. Silakan upload ulang bukti pembayaran. File yang diizinkan: JPG, JPEG, PNG, PDF (maks. 2MB)
                                    </div>
                                    <div class="mb-3">
